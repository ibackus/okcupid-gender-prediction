...
class LinearRandom():
    ...
    def __init__(self, x, y, scalarOffset=True, learningRateScale=1e-6, 
                 ...
                 lossScheme='linear binary', tau0=1., kappa=0., nRandFeatures=1000):
        """
        Trains a linear model using the randomMap as a feature map, using
        ...
        self._setup(scalarOffset, learningRateScale, lossScheme, nRandFeatures)
    ...
    def _setup(self, scalarOffset=None, learningRateScale=None, lossScheme=None,
        ...
        """
        self.initFeatureMap(scalarOffset, nRandFeatures)
    ...
    def initFeatureMap(self, scalarOffset=None, nRandFeatures=None):
        """
        ...
        if nRandFeatures is None:
            nRandFeatures = self.nRandFeatures
        self.nRandFeatures = nRandFeatures
        self.scalarOffset = scalarOffset
        # Set up feature map
        self.featureMap = randomMap.RandomMap(self.x.shape[1], nRandFeatures, 0, \
